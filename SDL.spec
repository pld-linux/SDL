...
Patch6:		%{name}-no_rpath_in_sdl-config.patch
...
myszy oraz klawiatury, Moze obsЁugiwaФ zarСwno okienkowy tryb XFree86
jak i DGA. Konstruuj╠c j╠ miano na uwadze przeno╤no╤Ф: aplikacje
konsolidowane z SDL mo©na rСwnie© budowac w systemach Win32 i BeOS.
